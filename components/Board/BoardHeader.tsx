...
const BOARD_COLORS = [
  { label: 'ازرق', value: 'from-blue-600 to-indigo-700' },
  { label: 'بنفسجي', value: 'from-violet-600 to-purple-700' },
  { label: 'اخضر', value: 'from-emerald-600 to-teal-700' },
          ...
          <div className="space-y-2">
            ...
            <div className="flex gap-2">
              <button
                ...
                className="flex-1 bg-white/5 border border-white/10 text-slate-300 py-1.5 rounded-lg text-xs transition-colors"
              >
                إلغاء
              </button>
              <button
    ...
    <header className="h-14 flex items-center gap-3 px-4 bg-black/25 backdrop-blur-sm border-b border-white/10 text-white" dir="rtl">
      ...
      <div className="relative">
        <button
          ...
          className={`text-white/70 hover:text-white text-sm border rounded-lg px-3 py-1.5 transition-all flex items-center gap-1.5 ${
            settingsOpen
              ? 'bg-blue-600/20 border-blue-500/30 text-blue-300'
              : 'bg-white/10 hover:bg-white/[0.16] border-white/10 hover:border-white/20'
          }`}
        >
          <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75" strokeLinecap="round">
